...
/*   Updated: 2026/04/24 13:29:34 by fbendnan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int dongle_take(t_dongle *d, t_coder *coder)
{
    ...
    long now;
    //why we must lock the mutex if we are not deciding if we gonna use it or not we can get a double lock is this normal ????
    ...
    {
        d->in_use = 1;
        //why we must unlock the mutex if it not do compilation ?
